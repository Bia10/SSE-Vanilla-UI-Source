...
// Private Methods:
	private function configUI():Void {
		...
		if (downArrow == null) { downArrow = new Button(); }
		if (upArrow == null) { upArrow = new Button(); }
		...
		upArrow.useHandCursor = !_disabled; downArrow.useHandCursor = !_disabled; thumb.useHandCursor = !_disabled;
		upArrow.disabled = _disabled; downArrow.disabled = _disabled; track.disabled = _disabled;
		upArrow.focusTarget = this; downArrow.focusTarget = this;
		upArrow.autoRepeat = true; downArrow.autoRepeat = true;
